    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-slate-500 hover:text-white"
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-indigo-500 text-white hover:bg-indigo-700 hover:text-white focus:bg-indigo-500 focus:text-white",
        day_today: "bg-indigo-500 text-white",
        day_outside:
